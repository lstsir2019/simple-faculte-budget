...
public class BudgetCompteBudgitaireServiceImpl implements BudgetCompteBudgitaireService {
    ...
    public int payerBCB(String code) {
        ...
        if (bcb == null) {
            ...
            budgetEntiteAdministratifService.payerBudgetEA(bcb.getBudgetSousProjet(), nvpaye);
            return 1;
        }
    }
