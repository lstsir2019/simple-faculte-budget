iiiiiiiiiiii-- phpMyAdmin SQL Dump
-- version 4.8.4
-- https://www.phpmyadmin.net/
--
-- Host: 127.0.0.1
-- Generation Time: Mar 11, 2019 at 11:10 PM
...
--
CREATE DATABASE IF NOT EXISTS `simple_faculte_budget` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `simple_faculte_budget`;
...
CREATE TABLE `budget_compte_budgitaire` (
  ...
  `code_bcb` varchar(255) DEFAULT NULL,
